...
def main():
	...
	cv2.rectangle(img, (50, 50), (400, 200), (255, 0, 0), thickness=2)
	...
	cv2.line(img, (100, 300), (600, 100), (0, 0, 255), thickness=5)
	
	# Add text
	font = cv2.FONT_HERSHEY_SIMPLEX
	cv2.putText(img, 'intro OpenCV', (200, 300), font, 1.5, (255, 255, 255), 2)
	...
	while True:
		...
		if cv2.getWindowProperty('OpenCV Basics', cv2.WND_PROP_VISIBLE) < 1:
			break
